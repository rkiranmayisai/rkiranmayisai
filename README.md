  ...
  <tr>
    <td style="background-color: #0d1117; border: 1.5px solid #00e5ff; border-radius: 12px; padding: 20px;">
      <p style="margin-bottom: 8px;">
        <b style="color: #50fa7b;">rkiranmayisai@developer</b>:<b style="color: #00e5ff;">~</b>$ npx rkiranmayisai --system-info
      </p>
      <p style="color: #50fa7b; margin-bottom: 12px;">
        ✔ Initializing Kiranmayi OS v2.5... OK
      </p>
      <hr style="border: 0.5px solid #30363d; margin: 12px 0;" />
      <pre style="white-space: pre-wrap; word-break: break-word; color: #c9d1d9; font-size: 0.9rem; margin: 0;"><code><b style="color: #ff1744;">🚀 DEVELOPER IDENTIFIER</b> : Reddy Kiranmayi
<b style="color: #e84393;">🎓 ACADEMIC DEGREE   </b> : B.Tech CSE @ ACE Engineering College
<b style="color: #8a2be2;">🔥 CORE SKILL MATRIX </b> : Java • Python • React • Node.js • MySQL
<b style="color: #ffd700;">🏆 COMPETITIVE RANKS </b> : GFG College Rank #2 🏆 • CodeChef 2-Star ⭐
<b style="color: #00e5ff;">⚡ PROBLEM SOLVING   </b> : 500+ Solved (LeetCode 1238 + GFG 300+)
<b style="color: #50fa7b;">💼 AVAILABILITY      </b> : Open for Software Engineering Internships 🚀</code></pre>
    </td>
  </tr>
</table>
